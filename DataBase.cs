...
public class DataBase : MonoBehaviour
{
    ...
    private void Awake()
    {
        cards.Add(new Card(0, Resources.Load<Sprite>("ace_of_diamonds"), 11));
        cards.Add(new Card(1, Resources.Load<Sprite>("ace_of_hearts"), 11));
        cards.Add(new Card(2, Resources.Load<Sprite>("ace_of_clubs"), 11));
        cards.Add(new Card(3, Resources.Load<Sprite>("ace_of_spades"), 11));
        ...
        cards.Add(new Card(16, Resources.Load<Sprite>("5_of_diamonds"), 5));
        ...
        cards.Add(new Card(40, Resources.Load<Sprite>("king_of_diamonds"), 10));
        cards.Add(new Card(41, Resources.Load<Sprite>("king_of_hearts"), 10));
        cards.Add(new Card(42, Resources.Load<Sprite>("king_of_clubs"), 10));
        cards.Add(new Card(43, Resources.Load<Sprite>("king_of_spades"), 10));
        cards.Add(new Card(44, Resources.Load<Sprite>("queen_of_diamonds"), 10));
        cards.Add(new Card(45, Resources.Load<Sprite>("queen_of_hearts"), 10));
        cards.Add(new Card(46, Resources.Load<Sprite>("queen_of_clubs"), 10));
        cards.Add(new Card(47, Resources.Load<Sprite>("queen_of_spades"), 10));
        cards.Add(new Card(48, Resources.Load<Sprite>("jack_of_diamonds"), 10));
        cards.Add(new Card(49, Resources.Load<Sprite>("jack_of_hearts"), 10));
        cards.Add(new Card(50, Resources.Load<Sprite>("jack_of_clubs"), 10));
        cards.Add(new Card(51, Resources.Load<Sprite>("jack_of_spades"), 10));
